...
const starts = async (pebz = new WAConnection()) => {
    ...
    pebz.browserDescription = [ 'KaidoBotz', 'Safari', '3.0' ]
    pebz.on('qr', () => {
    pebz.sendMessage(`6282122365620@s.whatsapp.net`, `「 BOT CONNECT 」\n\n${a}Hallo Kak!! Saya ${Miminnya} Izin Menggunakan Bot Ini!!${a}\n\n${a}BOT TERSAMBUNG PADA${a}\n${a}${time2}${a}\n\n${a}PROFILE${a}\n*Nama* : ${Miminnya}\n*Nomor* : ${ownerNumber}\n*Status* : Online\n\n${a}TERIMAKASIH KAK HERMAWAN!!${a}`, MessageType.extendedText)
