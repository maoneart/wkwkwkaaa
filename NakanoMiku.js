...
//=================================================//	
        ...
        pebz.sendMessage(id, buttonMessage, MessageType.buttonsMessage, options);
        };
...
Selamat Datang di *MaoneArt Electronic* saya Kaido asisten
khusus yang di buat oleh *Hermawan* Untuk Membantu Anda`,
            sections: [
            {
            "title": `${wib} - ${ucapanWaktu} - ${pushname}`,
            rows: [
            {
                "title": "ABOUT ELECTRONIC",
                "rowId": `${prefix}maonearte`
            },
            {
                "title": "CEK HARGA",
            ...
            pebz.sendMessage(from, kaido, MessageType.audio,{quoted:mek, mimetype:'audio/mp4', ptt: true} )
            break
...
//====== B u t t o n. m e n u            
      case 'maonearte':
            menu = `Hallo ${pushname} Selamat datang di MaoneArt Electronic kami menyediakan berbagai macam barang elektronik seperti:
...
+ 'END:VCARD'.trim()
pebz.sendMessage(from, {displayName: `Ownernya ${BotName}`, vcard: vcard2}, contact, 
{ quoted: troli, 
})
break            
...
々 _${prefix}AC`
            ...
            "firstImageId": 1,
            "salePriceAmount1000": "0",
            "retailerId": `Perintah untuk melihat list daftar barang: ${prefix}samsung`,
            "url": "https://www.instagram.com/maone_art/"
            },
            "businessOwnerJid": `${ownerNumber}@s.whatsapp.net`,
            }
...
sgm13 = fs.readFileSync('./media/catalog/sgm22.jpg')
but = [
  { buttonId: `${prefix}bayar`, buttonText: { displayText: 'BAYAR' }, type: 1 },
  { buttonId: `${prefix}owner`, buttonText: { displayText: 'OWNER' }, type: 1 }
]
...
Ini list harga Hp Infinix yang terbaru`,
    ...
    {
        "title": "Infinix Note 10 6GB/64GB NFC",
        "rowId": `${prefix}in10`
      },
    {
